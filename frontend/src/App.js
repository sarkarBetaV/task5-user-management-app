...
const EmailVerification = () => {
  ...
  const [verificationStatus, setVerificationStatus] = React.useState('verifying'); // 'verifying', 'success', 'failed'
    ...
    return (
      <div style={styles.container}>
        <div style={styles.card}>
          ...
          <p style={styles.smallText}>Token: {token ? `${token.substring(0, 15)}...` : 'None'}</p>
        </div>
      </div>
    );
  }
